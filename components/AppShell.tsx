...
export function AppShell({ children, overview = false, activePath = "/" }: { children: React.ReactNode; overview?: boolean; activePath?: string }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-ink)]">
      ...
      <main className={isOverview ? "pb-24 xl:pb-0" : "pb-24 xl:ml-[250px] xl:pb-8"}>
        <div className={isOverview ? "mx-auto max-w-[1440px] px-4 py-6 sm:px-6 xl:px-10 xl:py-10" : "mx-auto max-w-[1220px] px-4 py-5 sm:px-6 xl:px-8"}>{children}</div>
      </main>
